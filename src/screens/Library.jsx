...
const ARTICLES = [
  ...
  {
    id: 'art-pms-pmdd',
    title: 'Is It Normal PMS or PMDD? How to Tell the Difference',
    category: 'Mood & Sleep',
    readTime: '4 min',
    featured: false,
    emoji: '🌙',
    ...
    tagColor: '#4338CA',
    snippet: 'Mild irritability before your period is common, but feeling completely overwhelmed or hopeless isn’t something you have to just live with.',
    content: [
      ...
      'PMDD (Premenstrual Dysphoric Disorder) is different. It’s an intense reaction in brain neurotransmitters to normal hormonal shifts during the luteal phase.',
      'Signs PMDD might be present: severe emotional crashes, intense anxiety, rage or hopelessness that completely vanishes within 1–2 days after your period begins.',
    ...
    takeaway: 'Severe luteal mood shifts are neurochemical, not personal weakness. There are effective medical treatments.',
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      'Ask Direct Questions: "Could this severity be endometriosis or dysmenorrhea? What are prescription options besides regular ibuprofen?"',
    ],
