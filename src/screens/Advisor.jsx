...
Patient is tracking menstrual cycle symptoms to discuss pain management, symptom timing, heavy bleeding, spotting, missed periods, fatigue, or other changes that may need follow-up.
          ...
          <Card>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div style={{ padding: '10px 12px', background: '#F8F9FA', borderRadius: 10, fontSize: 13 }}>
                ❓ <em>"Is this pain level or bleeding pattern outside the usual range for my age?"</em>
              </div>
              <div style={{ padding: '10px 12px', background: '#F8F9FA', borderRadius: 10, fontSize: 13 }}>
